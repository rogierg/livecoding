...
// ARPEGGIO
$: note("[0 1 2 3]")                                      // too low — why?
  //note("[0 1 2 3]".add(62))                             // .add(62) shifts to D4 — mechanical (chromatic)
  //note("[0 2 4 0]".add(62))                             // piano lessons — Frère Jacques
  ...
  .sound("supersaw")
  .attack(0.01).decay(0.5).release(0.1)
